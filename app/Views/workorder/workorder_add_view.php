            ...
            <div class="row">
              <div class="col-sm-6 col-md-12">
                ...
                <div class="card card-warning card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Form Tambah Work Order</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->  
                  <?php
                      ...
                      // validation_errors()
                  ?>
                  <form action="<?= base_url('workorder/insert');?>" method="POST">
                  <?= csrf_field(); ?>
                    <!--begin::Body-->
                    <div class="card-body">
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control <?= ($validation->hasError('product_name')) ? 'is-invalid' : ''; ?>" id="product_name" name="product_name" value="<?= old('product_name'); ?>"/>   
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control <?= ($validation->hasError('quantity')) ? 'is-invalid' : ''; ?>" id="quantity" name="quantity" value="<?= old('quantity'); ?>"/>
                      ...
                      <!-- <div class="row mb-3">
                        <label for="validationCustom04" class="col-sm-2 col-form-label">Status</label>
                        <div class="col-sm-10">
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    for(let i=0; i<response.length; i++){
                        $('#operator').append(`<option value="${response[i].id}">${response[i].id} - ${response[i].name}</option>`);
                    }
                },
                async: false,
                error: function(e){
